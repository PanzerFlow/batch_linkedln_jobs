...
def remove_stops_words (desc_text : str) -> str:
  stopwords_core = {
          ...
          "t", "than", "that", "thats", "the", "their", "theirs", "them", "themselves", "then", "there", "these", "they", "this", "those", 
          "through", "to", "too", 
          "under", "until", "up", 
          "very", 
          "was", "wasnt", "we", "were", "werent", "what", "when", "where", "which", "while", "who", "whom", "why", "will", "with", "wont", "would", 
          "y", "yo", "your", "yours", "yourself", "yourselves","you"
  }
  
  stopwords_supplement = {
  ...
  stopwords = stopwords_core.union(stopwords_supplement,stopwords_custom)
  
  desc_text_lower = desc_text.lower()
  desc_text_list = desc_text_lower.split(" ")
  desc_text_list = list(filter(lambda x: x!="",desc_text_list))
